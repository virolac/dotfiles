...
legendary.setup {
  keymaps = {
    ...
    describe("<M-e><M-p>", "[TS] Swap with previous element"),
    describe("<M-e><M-n>", "[TS] Swap with next element"),
    describe("<M-f><M-p>", "[TS] Swap with previous function"),
    describe("<M-f><M-n>", "[TS] Swap with next function"),
    describe("<M-p><M-p>", "[TS] Swap with previous parameter"),
    describe("<M-p><M-n>", "[TS] Swap with next parameter"),
    describe("<M-v><M-p>", "[TS] Swap with previous variable"),
    describe("<M-v><M-n>", "[TS] Swap with next variable"),
